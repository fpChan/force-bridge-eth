...
contract TokenLockerBench {
    ...
    function unlockToken(bytes memory proof, bytes memory mockRawTx) external {
...
//            console.logString("_proveTxExist success");
